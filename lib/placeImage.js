...
export const makeCoordinateObj = (labelCoordinates, englishCoordinates, kanjiCoordinates, cityImageCoordinates, labelDimensions, kanjiRotation, englishRotation, kanji) => {
...
export const placeImage = (labelId, coordinates) => {
  ...
  labelImageBg.setAttributeNS(null, 'class', 'visible label-image-bg');
  ...
  const labelImageBgAlt = document.createElementNS(svgNs, 'image');
  labelImageBgAlt.setAttributeNS(null, 'class', 'hidden label-image-bg-alt' + labelId);
  labelImageBgAlt.setAttributeNS(null, 'id', 'label' + labelId + '-image-bg-alt');
  labelImageBgAlt.setAttributeNS(null, 'href', 'images/svg/' + labelId + '_label_alt.svg');
  labelImageBgAlt.setAttributeNS(null, 'x', coordinates.labelCoordinates[0]);
  labelImageBgAlt.setAttributeNS(null, 'y', coordinates.labelCoordinates[1]);
  labelContainer.appendChild(labelImageBgAlt);

...
export const userInterface = () => {
  ...
  const makeMouseOverListener = (selectionName) => {
    const listener = () => {
      ...
      aoyamaitchomeLabel.classList.remove('label-content-unselected');
      aoyamaitchomeLabel.classList.add('label-content-selected');
      ...
      aoyamaitchomeKanji.classList.remove('label-content-unselected');
      aoyamaitchomeKanji.classList.add('label-content-selected');
      aoyamaitchomeEnglish.setAttribute('fill', '#09fffbff');
      aoyamaitchomeEnglish.classList.remove('label-content-unselected');
      aoyamaitchomeEnglish.classList.add('label-content-selected');
  ...
  const makeMouseOutListener = (selectionName) => {
    const listener = () => {
      ...
      aoyamaitchomeLabel.classList.remove('label-content-selected');
      aoyamaitchomeLabel.classList.add('label-content-unselected');
  
      const aoyamaitchomeKanji = document.getElementById('aoyamaitchome-label-kanji');
      const aoyamaitchomeEnglish = document.getElementById('aoyamaitchome-label-english');
  
      aoyamaitchomeKanji.setAttribute('fill', 'white');
      aoyamaitchomeKanji.classList.remove('label-content-selected');
      aoyamaitchomeKanji.classList.add('label-content-unselected');
      aoyamaitchomeEnglish.setAttribute('fill', 'black');
      aoyamaitchomeEnglish.classList.remove('label-content-selected');
      aoyamaitchomeEnglish.classList.add('label-content-unselected');
